                ...
                Scaffold(
                    ...
                    content = { innerPadding ->
                        Surface(
                            modifier = Modifier
                                .fillMaxSize()
                                .padding(innerPadding), // Ensures safe area padding
                            color = MaterialTheme.colorScheme.background
                        ) {

                           UnitConverter(scope,snackbarHostState)
                        }
                    }
                )
            }
...
@Composable
fun UnitConverter(scope : CoroutineScope, snackbarHostState : SnackbarHostState){
